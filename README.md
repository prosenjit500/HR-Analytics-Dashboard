...
Users can interact with the dashboard by selecting different timeframes:
- **Weekday**
- **Month**
- **Quarter**
- **Year** (Selected)

Dropdown filters allow further segmentation by:
- **Year & Month**
- **Age Group**
- **Job Title**
...
### 1. **Team Breakdown by Job Title and Gender**
- Bar chart showing male vs female distribution across job roles.
- Notable equality in roles like *Packaging Associate*, *Product Manager*, and *Research Scientist*.

### 2. **Staff Gender Breakdown**
- Pie chart:
  - Female: 155 (54%)
  - Male: 132 (46%)

### 3. **Workforce Growth Trend by Join Date and Gender**
- Line chart showing consistent growth since 2017.
- Females slightly outpace males in recent years.

### 4. **Job Title-Wise Workforce and Salary Analysis**
- Table with job-wise breakdown:
  - Includes salary metrics, attrition rates, age, and average leave balance.
  - *Marketing Manager* has the highest average salary: **73.82K**
  - *Production Operator* has the lowest attrition rate: **5.41%**
  - *Chocolatier* has the highest attrition rate: **25.00%**

### 5. **Attrition Rate by Year and Gender**
- Line chart showing:
  - Fluctuations from 2017 to 2023.
  - Female attrition rate spiked at 40% in 2021.
  - Male attrition peaked in 2017 and dropped significantly after.

### 6. **Workforce Breakdown by Age Group**
- Bar chart showing age distribution segmented by gender:
